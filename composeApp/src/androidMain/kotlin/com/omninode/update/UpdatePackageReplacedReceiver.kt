...
/**
 * After the system finishes replacing this package, relaunch OmniNode to the foreground.
 *
...
class UpdatePackageReplacedReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        println("UpdatePackageReplacedReceiver: package replaced — relaunching OmniNode")
